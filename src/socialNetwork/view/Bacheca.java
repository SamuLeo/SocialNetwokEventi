...
public class Bacheca extends JPanel {
	...
	Bacheca(int larghezza, Font testo, Font testoBottoni, int altezzaStringhe) {
		...
		for (int i=0; i<10; i++) {
			...
			cards[i]=new cardEvento(new PartitaCalcio("Brescia", datafine, data, 12, 0, "Partita di calcio", null, null, null, 18, 32, "Qualsiasi"), larghezza-60, testoBottoni, testo, altezzaStringhe);
