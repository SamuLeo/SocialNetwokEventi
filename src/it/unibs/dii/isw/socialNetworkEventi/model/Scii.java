...
public class Scii extends Evento
{
	...
	throws IllegalArgumentException
	{
		...
		{
			PreparedStatement ps = con.prepareStatement(Stringhe.INSERT_SQL_SCII, Statement.RETURN_GENERATED_KEYS);
...
//			Campi Scii
		...
		{
			PreparedStatement ps = con.prepareStatement(Stringhe.INSERT_SQL_UTENTE_SCII);
		...
		{
			PreparedStatement ps = con.prepareStatement(Stringhe.SELECT_SQL_UTENTI_SCII);
		...
		{
			PreparedStatement ps = con.prepareStatement(Stringhe.UPDATE_SQL_STATO_SCII);
		...
		{
			PreparedStatement ps = con.prepareStatement(Stringhe.DELETE_SQL_SCII);
			ps.setInt(1, this.getId());
		...
		{
			PreparedStatement ps = con.prepareStatement(Stringhe.DELETE_SQL_RELAZIONE_UTENTE_SCII);
